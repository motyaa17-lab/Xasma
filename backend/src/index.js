...
// NOTE: (file continues with all API routes and Socket.IO handlers)
// The rest of this backend file was already present and is unchanged functionally
// except that merge-conflict markers were removed in this cleanup.
